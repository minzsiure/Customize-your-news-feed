...
class PhraseTrigger(Trigger):
    def __init__(self, phrase):
        self.phrase = phrase #add a new data attribute
        
    def get_phrase (self): #constructor
        return self.phrase
    
    def is_phrase_in (self, text): #new method
        ...
        #make punct becomes space; this is a string
        
        cleaned_text = ' '.join(no_punct_text.split()) + ' '
        #no_punct_text.split() is a list of words
        #cleaned_text is a string of sentense with one space in between
        ...
        #no_punct_phrase.split() is a list of words
        #cleanred_text is a string of sentense with one space in between
...
def filter_stories(stories, triggerlist):
    ...
    for story in stories:
        ...
        #evaluate every tigger in triggerlist with a story input
            
            filtered_stories.append(story) 
            #if the trigger is true, add into the list
...
def read_trigger_config(filename):
    ...
    def line_reader(line):
        data = line.split(',') 
        #split the string with an ',' to form a list
        
        if data[0] != "ADD": 
        #if the first keyword of the list is not "ADD"
            
            if data[1] == "OR" or data[1] == "AND": 
            #check if the second keyword of the list is OR or AND
